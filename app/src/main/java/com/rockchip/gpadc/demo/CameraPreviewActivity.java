...
public class CameraPreviewActivity extends Activity implements Camera.PreviewCallback {
    ...
    // for inference
    private String mModelName = "logo_rk356x_i8.rknn";
    private String platform = "rk3566";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //     createFile(mModelName, R.raw.yolov5s_rk3588);
        // }
        createFile(mModelName, R.raw.logo_rk356x_fp);
...
//            Log.e("letianpai_bottom","detection.left: "+detection.left);
//            Log.e("letianpai_bottom","detection.right: "+detection.right);
//            Log.e("letianpai_bottom","detection.top: "+detection.top);
//            Log.e("letianpai_bottom","detection.bottom: "+detection.bottom);
            // Log.e("position", "detection 左上 （" + detection.left + " ," +  detection.top + ") 右下 ( " + detection.right + " ," + detection.bottom + ')');
            Log.e("position", "detection.middle: " + (detection.left + detection.right) / 2);
